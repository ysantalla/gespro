        ...
        <div class="mat-elevation-z8">
          <mat-card class="proyecto-details-card">
            ...
            <mat-card-content>
              ...
              <mat-grid-list *ngIf="proyectoData" cols="2" rowHeight="6:1">
                ...
                <mat-grid-tile><h3 class="mat-h3">Area a la que pertenece:</h3></mat-grid-tile>
            ...
            <mat-card-actions>
              <button mat-raised-button color="accent" routerLink="/profesor/project" routerLinkActive type="button" aria-label="details">
