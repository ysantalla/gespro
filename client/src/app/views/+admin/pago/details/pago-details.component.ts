      ...
      <div class="item" fxFlex="50%" fxFlex.xs="98%" fxFlex.md="70%">
        ...
        <div class="mat-elevation-z8">
          <mat-card class="pago-details-card">
            ...
            <mat-card-actions>
              <button mat-raised-button color="accent" [routerLink]="['/admin','project', projectId, 'integrante', integranteId, 'pagos']"
                  routerLinkActive type="button" aria-label="details">
                <mat-icon>list</mat-icon>
                <span>Listado de pagos</span>
              </button>
              <button *ngIf="pagoData" mat-raised-button color="primary"
                 [routerLink]="['/admin', 'project', projectId, 'integrante', integranteId, 'pago', 'update', pagoData.id]"
