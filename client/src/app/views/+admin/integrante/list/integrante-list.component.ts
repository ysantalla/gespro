      ...
      <div fxLayout="row" class="buttons" fxLayoutAlign="start center">
        <div class="item" fxFlex="25%">
          <a class="create-button" mat-raised-button color="primary"
                    [routerLink]="['/admin','project', projectId, 'integrante', 'create']" routerLinkActive="active">
        ...
        <div class="item" fxFlex="25%">
          <a class="create-button" mat-raised-button color="primary"
                    [routerLink]="['/admin','project', projectId, 'integrante', 'directory']" routerLinkActive="active">
            <mat-icon>add</mat-icon>
        ...
        <div class="item" fxFlex="25%">
          <a class="projects" mat-raised-button color="accent"
                    [routerLink]="['/admin','project']" routerLinkActive="active">
              ...
              <mat-table #table [dataSource]="dataSource" matSort aria-label="Elements">
                ...
                <ng-container matColumnDef="payment">
                  ...
                  <mat-cell fxFlex="7" *matCellDef="let row">
                    <a mat-icon-button color="accent" [routerLink]="['/admin','project', projectId, 'integrante', row.id, 'pagos']"
                ...
                <ng-container matColumnDef="details">
                  ...
                  <mat-cell fxFlex="7" *matCellDef="let row">
                    <a mat-icon-button color="accent" [routerLink]="['/admin','project', projectId, 'integrante', 'details', row.id]"
                          routerLinkActive="active">
                ...
                <ng-container matColumnDef="edit">
                  ...
                  <mat-cell fxFlex="7" *matCellDef="let row">
                    <a mat-icon-button color="primary" [routerLink]="['/admin','project', projectId, 'integrante', 'update', row.id]"
                      routerLinkActive="active">
      ...
      if (result) {
        ...
        this.apollo.mutate({
          ...
          if (data) {
            ...
            this.snackBar.open(`Los ${data.deleteManyIntegrantes.count} integrantes fueron eliminados correctamente`, 'X', {duration: 3000});
          }
        }, (error) => {
          this.loading = false;
          if (error.graphQLErrors.length > 0) {
