...
import { Users } from '@app/graphql/types';
            ...
            <mat-card class='integrante-card'>
              ...
              <mat-card-actions>
                ...
                <a
                  mat-raised-button
                  color='accent'
                  [routerLink]="['/admin','project', projectId, 'integrantes']"
                  routerLinkActive
                  type='button'
...
export class DirectoryComponent implements OnInit {
  ...
  onCreateProfesor() {
    ...
    if (this.addProfesorForm.valid) {
      ...
      if (this.addProfesorForm.value.jproyecto) {
        roles = {
          connect: [
            {
              name: 'PROFESOR'
        ...
        .mutate({
          ...
          variables: {
            data: {
              ...
              jefeProyecto: this.addProfesorForm.value.jproyecto || false
            },
            whereInput: {
              usuario: {
                username: this.addProfesorForm.value.usuario.username
        ...
        .subscribe(
          ({ data }) => {
            ...
            if (data) {
              ...
              this.router.navigate(['admin', 'project', this.projectId, 'integrantes']);
            }
          },
          (error) => {
            this.loading = false;
