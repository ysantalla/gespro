      ...
      <div class="item" fxFlex="50%" fxFlex.xs="98%" fxFlex.md="70%">
        ...
        <div class="mat-elevation-z8">
          <mat-card class="role-details-card">
            <mat-card-header>
              <mat-card-title>
                <h1 class="mat-h1">Detalles Rol</h1>
              </mat-card-title>
            </mat-card-header>
            ...
            <mat-card-content>
              ...
              <div *ngIf="roleData">
                ...
                <mat-grid-list cols="2" rowHeight="6:1">
                    ...
                    <mat-grid-tile><h3 class="mat-h3"> {{roleData.id}}</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3">Nombre:</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3"> {{roleData.name}}</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3">Descripción:</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3"> {{roleData.description}}</h3></mat-grid-tile>
