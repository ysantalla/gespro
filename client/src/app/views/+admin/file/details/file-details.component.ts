      ...
      <div class="item" fxFlex="50%" fxFlex.xs="98%" fxFlex.md="70%">
        ...
        <div class="mat-elevation-z8">
          <mat-card class="file-details-card">
            <mat-card-header>
              <mat-card-title>
                <h1 class="mat-h1">Detalles Archivo</h1>
              </mat-card-title>
            </mat-card-header>
            ...
            <mat-card-content>
              ...
              <div *ngIf="fileData">
                ...
                <mat-grid-list cols="2" rowHeight="6:1">
                    ...
                    <mat-grid-tile><h3 class="mat-h3"> {{fileData.id}}</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3">Nombre:</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3"> {{fileData.filename}}</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3">Tipo:</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3"> {{fileData.mimetype}}</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3">Codificación:</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3"> {{fileData.encoding}}</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3">Tamaño:</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3"> {{fileData.size | size}}</h3></mat-grid-tile>
                    <mat-grid-tile><h3 class="mat-h3">Link de Descarga</h3></mat-grid-tile>
                    <mat-grid-tile>
