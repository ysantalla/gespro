      ...
      <div class="item" fxFlex="50%" fxFlex.xs="98%" fxFlex.md="70%">
        ...
        <div class="mat-elevation-z8">
          <mat-card class="integrante-details-card">
            ...
            <mat-card-actions>
              <button mat-raised-button color="accent" [routerLink]="['/jproject','project', projectId, 'integrantes']"
                  routerLinkActive type="button" aria-label="details">
                <mat-icon>list</mat-icon>
                <span>Listado de integrantes</span>
              </button>
              <button *ngIf="integranteData" mat-raised-button color="primary"
                 [routerLink]="['/jproject', 'project', projectId, 'integrante', 'update', integranteData.id]"
