      ...
      <div fxLayout="row" class="buttons" fxLayoutAlign="start center">
        <div class="item" fxFlex="15%">
          <a class="create-button" mat-raised-button color="primary"
                    [routerLink]="['/jproject','project', projectId, 'integrante', integranteId ,'pago','create']"
        ...
        <div class="item" fxFlex="15%">
          <a class="projects" mat-raised-button color="accent"
                    [routerLink]="['/jproject','project', projectId, 'integrantes']" routerLinkActive="active">
              ...
              <mat-table #table [dataSource]="dataSource" matSort aria-label="Elements">
                ...
                <ng-container matColumnDef="details">
                  ...
                  <mat-cell fxFlex="7" *matCellDef="let row">
                    ...
                    [routerLink]="['/jproject','project', projectId, 'integrante', integranteId, 'pago', 'details', row.id]"
                          routerLinkActive="active">
                ...
                <ng-container matColumnDef="edit">
                  ...
                  <mat-cell fxFlex="7" *matCellDef="let row">
                    <a mat-icon-button color="primary"
                        [routerLink]="['/jproject','project', projectId, 'integrante', integranteId, 'pago', 'update', row.id]"
                      routerLinkActive="active">
...
export class PagoListComponent implements OnInit, AfterViewInit, OnDestroy {
  public dataSource: MatTableDataSource<Pago.Pago>;
